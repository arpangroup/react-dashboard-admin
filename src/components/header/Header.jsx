...
const Header = ({ onToggleSidebar }) => {
  ...
  const handleLogout = (e) => {
    e.preventDefault();
    localStorage.clear();
    // Simulate logout - in production, use actual API
          ...
          <div className="single-nav-right">
            ...
            {userMenuOpen && (
              <ul className="dropdown-menu dropdown-menu-end show">
                ...
                <li className="logout">
                  <a href="/admin/logout" className="dropdown-item" onClick={handleLogout}>
                    <i icon-name="log-out"></i> Logout
                  </a>
                  <form id="logout-form" action="/admin/logout" method="POST" className="d-none">
                    <input type="hidden" name="_token" value="tAlWAwzyEa2XNDEaOQGfJURs5sqf66BiknGdP3Yk" />
                  </form>
                </li>
              </ul>
            )}
