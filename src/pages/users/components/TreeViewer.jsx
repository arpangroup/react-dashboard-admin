...
const resetZoom = () => {
  ...
  <div className="controls">
    <button className="site-btn-xs primary-btn me-2" onClick={() => zoom(0.1)}>Zoom In</button>
    <button className="site-btn-xs primary-btn me-2" onClick={() => zoom(-0.1)}>Zoom Out</button>
    <button className="site-btn-xs primary-btn me-2" onClick={resetZoom}>Reset</button>
  </div>
