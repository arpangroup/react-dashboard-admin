            ...
            <div className="site-card">
              <div class="site-card-header">
                ...
                <div class="card-header-links">
                  <a href="https://81habibi.com/admin/email-template" class="card-header-link">Back</a>
                </div>
              </div>

              <div class="site-card-body">
                <form action="https://81habibi.com/admin/email-template-update" method="post" enctype="multipart/form-data">
